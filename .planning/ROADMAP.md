...
**Plans**: 4 plans in 3 waves (2 parallel TDD modules → UI surfaces → integration + device checkpoint)
**Plan list**:
- [ ] 05-01-PLAN.md — Wall-clock session timing model (TDD: session.ts + vitest RED/GREEN)
...
| 5. Lossless Playback Navigation | v1.1 | 0/4 | Planned | - |
